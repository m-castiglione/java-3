...
class Regex {
    public static void main(String[] args) {
        ...
        System.out.println("The following pattern ('\\d'){36} matches : all digits with 36");
        ...
        for (int i = 0; i < TEKmentors.length; i++) {
            String test = TEKmentors[i].replaceAll("\\s.+$", "");
        ...
        String newArray = sleepy.replaceAll("sleepy", "");
